...
const (
	DATA_ICMP_PKT_GEN_REQUEST_EVENT EventType = SIMUE_REALUE_EVENT + 1 + iota
	DATA_UDP_PKT_GEN_REQUEST_EVENT
...
var evtStrMap map[EventType]string = map[EventType]string{
	...
	DATA_ICMP_PKT_GEN_REQUEST_EVENT:         "ICMP-DATA-PACKET-GENERATION-REQUEST-EVENT",
	DATA_UDP_PKT_GEN_REQUEST_EVENT:          "UDP-DATA-PACKET-GENERATION-REQUEST-EVENT",

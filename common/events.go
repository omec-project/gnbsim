...
const (
	...
	GUTI_REG_REQUEST_EVENT     //73

	SERVICE_REQUEST_EVENT = UE_5GS_MOBILITY_MANAGEMENT_EVENTS + 2 + iota //76
	SERVICE_REJECT_EVENT
	SERVICE_ACCEPT_EVENT //78

	AUTH_REQUEST_EVENT = UE_5GS_MOBILITY_MANAGEMENT_EVENTS + 9 + iota //86
	AUTH_RESPONSE_EVENT
	AUTH_REJECT_EVENT
	AUTH_FAILURE_EVENT
	AUTH_RESULT_EVENT
	...
	FIVE_GMM_STATUS_EVENT = UE_5GS_MOBILITY_MANAGEMENT_EVENTS + 12 + iota //86
	NOTIFICATION_EVENT
...
var evtStrMap map[EventType]string = map[EventType]string{
	...
	GUTI_REG_REQUEST_EVENT:                  "GUTI-REGESTRATION-REQUEST-EVENT",

...
const (
	...
	SERVICE_REJECT_EVENT                                                         // 77
	SERVICE_ACCEPT_EVENT                                                         // 78
	CONTROL_PLANE_SERVICE_REQUEST                                                // 79
	NS_SPECIFIC_AUTH_COMMAND                                                     // 80
	NS_SPECIFIC_AUTH_COMPLETE                                                    // 81
	NS_SPECIFIC_AUTH_RESULT                                                      // 82
	UNKNOWN_83
	CONFIG_UPDATE_COMMAND  // 84
	CONFIG_UPDATE_COMPLETE // 85

	AUTH_REQUEST_EVENT // 86
	AUTH_RESPONSE_EVENT
	AUTH_REJECT_EVENT
	AUTH_FAILURE_EVENT
	AUTH_RESULT_EVENT
	...
	FIVE_GMM_STATUS_EVENT = 100 + iota // 100
	NOTIFICATION_EVENT
...
const (
	...
	PDU_SESS_RESOURCE_MODIFY_REQUEST_EVENT
...
var evtStrMap map[EventType]string = map[EventType]string{
	...
	CONTROL_PLANE_SERVICE_REQUEST:           "CONTROL-PLANE-SERVICE-REQUEST",
	NS_SPECIFIC_AUTH_COMMAND:                "NS-SPECIFIC-AUTH-COMMAND",
	NS_SPECIFIC_AUTH_COMPLETE:               "NS_SPECIFIC_AUTH_COMPLETE",
	NS_SPECIFIC_AUTH_RESULT:                 "NS_SPECIFIC_AUTH_RESULT",
	CONFIG_UPDATE_COMMAND:                   "CONFIG-UPDATE-COMMAND",
	...
	PDU_SESS_RESOURCE_MODIFY_REQUEST_EVENT:  "PDU-SESSION-RESOURCE-MODIFY-REQUEST-EVENT",
